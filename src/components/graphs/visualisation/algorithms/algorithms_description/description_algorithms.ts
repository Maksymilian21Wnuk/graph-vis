...
export const description_text : string[] = [
    `Breadth first search is an algorithm used for traversing graph,
    by visiting adjacent neighbours and adding them to queue. Next
    step of algorithm extracts from queue and
    It runs in O(V+E) complexity.
    `,   
    `Here will be some description about
