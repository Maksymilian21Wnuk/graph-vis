...
export const fields : InfoFieldProps[] = [
    {
        title: "Graph definition TODO",
        content: `In graph theory, a graph is a structure consisting of nodes connected by edges.
    ...
    },
    {
        ...
        able to spawn graph with given probability. There is also a wide choice of pre-made graphs,
        for studying them with improved experience.`
    },
    {
        title: "About page",
