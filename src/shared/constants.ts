...
export {MIN_ZOOM, DOWNLOAD_COUNTER_NAME, INFINITY_ASCII, NO_WEIGHT, PORTRAIT_MIN_WIDTH, RED_ARROW_SVG, INVISIBLE_ARROW, VISITED_ARROW_SVG ,NO_ARROW, WIDTH, HEIGHT, NODE_MAX, nodeDefaultStyle, edgeDefaultStyle, NOT_SELECTED, TITLES, ARROW_SVG_ID}